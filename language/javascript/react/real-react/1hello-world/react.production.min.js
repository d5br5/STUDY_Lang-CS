...
(function (d, r) {
	...
	function ea(a, b, c) {
		var g,
			...
			d = null;
		if (null != b)
			for (g in (void 0 !== b.ref && (d = b.ref), void 0 !== b.key && (fa = "" + b.key), b))
		...
		return { $$typeof: x, type: a, key: fa, ref: d, props: e, _owner: M.current };
	}
	function va(a, b) {
		return { $$typeof: x, type: a.type, key: b, ref: a.ref, props: a.props, _owner: a._owner };
	}
	function N(a) {
	...
	function O(a, b, c, g) {
		...
		if (Array.isArray(a))
			...
			(null === a || "object" !== typeof a
				? (h = null)
				: ((h = (la && a[la]) || a["@@iterator"]), (h = "function" === typeof h ? h : null)),
			"function" === typeof h)
		)
			...
			throw (
				...
				Error(
					r(
						31,
						"[object Object]" === c ? "object with keys {" + Object.keys(a).join(", ") + "}" : c,
						""
					)
				))
			);
		...
		Array.isArray(a)
			...
			: null != a &&
			  (N(a) &&
					(a = va(
						a,
						e + (!a.key || (b && b.key === a.key) ? "" : ("" + a.key).replace(ma, "$&/") + "/") + c
					)),
			  g.push(a));
	}
