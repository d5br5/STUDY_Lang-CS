...
function fetchCountryInfo(countryCode: string, status: CovidStatus) {
	...
	const url = `https://api.covid19api.com/country/${countryCode}/status/${status}?from=2022-01-20T00:00:00Z&to=2022-01-22T00:00:00Z`;
	return axios.get(url);
}
...
function setDeathsList(data: Array<Country>) {
